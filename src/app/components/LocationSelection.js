...
const locations = [
  'Проспект Aль-Фараби 77/8, Алматы',
  'Проспект Туран 37, Астана',
]
      ...
      <div className="relative flex-1">
          ...
          xl:border-r xl:border-black/10">
            <div className="flex flex-col justify-center">
              ...
              gap-y-2 xl:gap-y-0"> 
                ...
                <div className="text-[15px uppercase font-bold">Выберите местоположение</div>
                </div>
        ...
        text-center xl:text-left w-full bg-white max-w-[332px] py-6 rounded-[10px]'>
          {locations.map((location, index)=>{
            ...
            key={index} 
            className="cursor-pointer pt-4 xl:pl-10 hover:bg-gray-50 text-[13px] 
            uppercase"
            >
              {location}
            </div>
